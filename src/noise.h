...
__constant__
    ...
    const Vec3f grad3[16] = {
        {-0.0101255, -0.332831, -0.942932}, {0.322723, -0.869862, -0.373081},
        {0.672098, 0.0938854, -0.734486},   {0.268604, -0.91964, -0.286554},
        {0.252045, -0.694893, -0.673496},   {-0.145087, -0.925064, -0.351008},
        {-0.557681, 0.655993, 0.508591},    {0.317359, -0.164076, -0.934003},
        {0.99561, 0.0827227, -0.0437889},   {-0.868747, -0.358256, -0.341951},
        {0.129141, 0.757184, -0.640309},    {-0.306622, 0.174409, -0.935716},
        {-0.964277, 0.16877, 0.204174},     {-0.654047, -0.301881, 0.693607},
        {0.935072, 0.15054, -0.320901},     {0.473575, -0.60944, 0.635854}};

// A fast hash function
inline HD Vec3f hash(int px, int py, int pz) {
  return grad3[perm[(px + perm[(py + perm[pz & 0xFF]) & 0xFF]) & 0xFF] & 0x0F];
}
...
inline HD real perlin(Vec3f v) {
  ...
  // trilinear smoothed interpolation
